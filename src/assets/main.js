...
window.onload = function(){
    const urlanchor = document.querySelectorAll('a.url');
    urlanchor.forEach(anchor => {
        // Get the base64 encoded URL from the href
        const encodedUrl = anchor.getAttribute('href').split('base64,')[1]; // Assuming the "base64," is part of the href
        if (encodedUrl) {
