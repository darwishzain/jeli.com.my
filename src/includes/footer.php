...
addjs("../assets/jquery-3.7.1.min.js");
addjs("../assets/bootstrap/bootstrap.bundle.min.js");
addjs("../assets/fontawesome/js/all.min.js");
addjs("../assets/main.js");

?>
<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.5.4/dist/umd/popper.min.js"></script>
<footer class="mt-2 py-4 bg-light text-dark text-center" style="width: 100%;">
    <ul class="list-unstyled d-flex">
        <li class="ms-3"><a class="link-dark" href="https://twitter.com/darwishzainstd"><i class="bi bi-twitter"></i></a></li>
        <li class="ms-3"><a class="link-dark" href="https://instagram.com/darwishzainstd"><i class="bi bi-instagram"></i></a></li>
        <li class="ms-3"><a class="link-dark" href="https://facebook.com/darwishzainstd"><i class="bi bi-facebook"></i></a></li>
